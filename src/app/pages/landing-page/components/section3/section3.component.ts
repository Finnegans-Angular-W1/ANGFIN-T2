...
export class Section3Component implements OnInit {
  ...
  featuresTab1:string[] = ['Dolar Oficial', 'Dolar Blue', 'Cambio automático a tasa actual', 'Rapidez'];
  featuresTab2:string[] = ['Rentabilidad garantizada', 'Seguridad de inversión', 'Flexibilidad en plazos de inversión', 'Opciones personalizadas', 'Monitoreo constante'];
  featuresTab3:string[] = ['En cualquier momento y lugar', 'Con cualquier divisa', 'Sin límite de transacciones', 'Sin costos adicionales', 'Interfaz intuitiva y fácil de usar'];
